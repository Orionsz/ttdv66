...
wget https://github.com/Orionsz/ttdv66/raw/main/files/$ClientFile -O $ClientFile
...
unzip $ClientFile;
if [ -d "ttdclientVS66.6-VS1.18-Lin22.04cu12.3" ]; then
    echo "Unzip successful: ttdclientVS66.6-VS1.18-Lin22.04cu12.3"
else
